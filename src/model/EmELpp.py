# Code adapted from https://github.com/kracr/EmELpp provided under the
...
class EmELpp(nn.Module):
    def __init__(
        self, device, class_, relationNum, embedding_dim, margin=0, reg_norm=1
    ):
    ...
    def nf2Loss(self, input):
        ...
        # re
        torch.reshape(torch.abs(e[:, -1]), [-1, 1])
