...
boxsqel_config = {
    "method": "bayes",
    "name": "PLACEHOLDER",
    "metric": {"goal": "minimize", "name": "surrogate"},
    "parameters": {
        "dataset": {"value": "PLACEHOLDER"},
        "lr": {"values": [0.001, 0.005, 0.01]},
        "lr_schedule": {"values": [2000, 10000]},
        "margin": {"max": 0.5, "min": 0.0},
        "neg_dist": {"distribution": "uniform", "max": 10.0, "min": 1.0},
        "num_neg": {"max": 5, "min": 1},
        "reg_factor": {"max": 0.5, "min": 0.0},
        "task": {"value": "PLACEHOLDER"},
        "model": {"value": "PLACEHOLDER"},
    },
}
...
boxel_config = {
    ...
    "parameters": {
        ...
        "model": {"value": "PLACEHOLDER"},
        "lr": {"values": [0.001, 0.005, 0.01]},
        "embedding_dim": {"values": [25, 50, 100, 200]},
    },
}
